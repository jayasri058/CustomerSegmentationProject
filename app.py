...
uploaded_file = st.file_uploader("E:/Jaya Lenovo Laptop Backup/Personal/Personal/InternshipWork/Customer Segmentation Project/Dataset/customer_segmentation_large_dataset.csv", type=["csv"])
